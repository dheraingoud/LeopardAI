...
export const MODELS: Model[] = [
  ...
  },
  {
    ...
    nimId: "stabilityai/stable-diffusion-xl-base-1.0",
  ...
  },
  {
    ...
    nimId: "microsoft/phi-3-vision-128k-instruct",
    name: "Phi-3 Vision 128K",
    provider: "Microsoft",
    description: "Compact multimodal model for image grounding and document-style visual QA.",
    contextWindow: 128000,
    speed: "medium",
    modality: "vision",
    badge: "Vision",
