// Leopard fork of assistant-ui agent-handoff — originals in addons/ are reference-only.
"use client";
      ...
      <div className="flex items-center gap-2">
        ...
        <ArrowRightIcon
          className={cn(
            ...
            settled ? "text-foreground/25" : "dark:text-[#ffb400] light:text-[#d49600]",
          )}
        />
        ...
        <span
          className={cn(
            ...
            settled
              ...
              : "bg-[#ffb400]/12 text-blue-700 dark:bg-[#ffb400]/15 dark:text-blue-300",
          )}
        >
          <BotIcon className="size-3" />
          {to}
