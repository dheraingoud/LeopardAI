// Leopard fork of assistant-ui retrieval-chunks — originals in addons/ are reference-only.
"use client";
        ...
        {take(chunks, visibleCount).map((chunk) => (
          ...
          >
            ...
            <span className="bg-foreground/[0.06] h-[2px] w-full overflow-hidden rounded-full">
              <span
                className="block h-full rounded-full bg-[#ffb400]/70 transition-[width] duration-500 dark:bg-[#ffb400]/70"
