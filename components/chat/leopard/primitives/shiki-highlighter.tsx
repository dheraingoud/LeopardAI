...
// Returns highlighted HTML once settled; null while streaming or before the
// highlighter warms — callers render plain code in the same container so
// settling is a color change, not a layout shift.
