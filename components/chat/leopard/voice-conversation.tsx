// Leopard fork of assistant-ui voice-conversation — originals in addons/ are reference-only.
"use client";
      ...
      >
        <span
          ...
          className={cn(
            ...
            mode === "speaking"
              ? "bg-[#ffb400]/12 dark:bg-[#ffb400]/15"
              : "bg-foreground/[0.05]",
          )}
          style={{
            width: "6rem",
        ...
        <span
          ...
          className={cn(
            ...
            mode === "speaking"
              ? "bg-[#ffb400]/20 dark:bg-[#ffb400]/25"
              : "bg-foreground/[0.08]",
          )}
          style={{
            width: "4.25rem",
        ...
        <span
          ...
          className={cn(
            ...
            mode === "speaking" && "dark:bg-[#ffb400] light:bg-[#d49600]",
          )}
          ...
          >
            <span
              className={cn(
                ...
                turn.role === "user"
                  ? "text-foreground/30"
                  : "text-[#ffb400]/70 dark:text-[#ffb400]/70",
              )}
            >
