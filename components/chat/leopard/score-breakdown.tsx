...
> & {
  ...
  return (
    <div
      ...
      className={cn(paper, "flex w-full max-w-sm flex-col gap-3 rounded-lg p-4", className)}
      {...props}
    >
        ...
        {take(criteria, visibleCount).map((criterion) => (
          ...
          >
            ...
            <span className="bg-foreground/[0.06] h-[3px] w-full overflow-hidden rounded-full">
              <span
                className="block h-full rounded-full transition-[width] duration-500 motion-reduce:transition-none dark:bg-[#ffb400] light:bg-[#d49600]"
