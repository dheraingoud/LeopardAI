// Leopard fork of assistant-ui chart — originals in addons/ are reference-only.
"use client";
        ...
        {variant === "bars" ? (
            ...
            return (
              <rect
                ...
                className={cn(
                  ...
                  i === lastIndex
                    ? "dark:fill-[#ffb400] light:fill-[#d49600] dark:fill-blue-400"
                    : "fill-foreground/25",
                )}
          ...
          <>
            {variant === "area" && shown.length > 1 && (
              <path
                d={area}
                className="fill-[#ffb400]/12 dark:fill-[#ffb400]/15"
              />
            )}
            <polyline
              points={line}
              ...
              vectorEffect="non-scaling-stroke"
              className="dark:stroke-[#ffb400] light:stroke-[#d49600] dark:stroke-blue-400"
            />
            {last && (
              <circle
                cx={last.x}
                cy={last.y}
                r="3"
                className="dark:fill-[#ffb400] light:fill-[#d49600] dark:fill-blue-400"
              />
            )}
          </>
        )}
