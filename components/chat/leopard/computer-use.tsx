// Leopard fork of assistant-ui computer-use — originals in addons/ are reference-only.
"use client";
      ...
      <div className="border-foreground/[0.07] relative min-h-[8.5rem] overflow-hidden border-t">
        ...
        {trail.map((step, i) => (
          <span
            key={step.id}
            aria-hidden
            className="pointer-events-none absolute size-2 rounded-full dark:bg-[#ffb400] light:bg-[#d49600] transition-opacity duration-300 dark:dark:bg-[#ffb400] light:bg-[#d49600]"
            style={{
              left: `${step.x}%`,
              top: `${step.y}%`,
              opacity: 0.18 * (i + 1),
        ...
        {active && (
          <MousePointer2Icon
            aria-hidden
            className="pointer-events-none absolute size-4 dark:fill-[#ffb400] light:fill-[#d49600] dark:text-[#ffb400] light:text-[#d49600] transition-[left,top] duration-500 ease-out motion-reduce:transition-none dark:fill-blue-400 dark:dark:text-[#ffb400] light:text-[#d49600]"
