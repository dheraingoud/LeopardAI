        ...
        {items.map((item) => (
          ...
          >
            <span className="flex size-4 h-5 shrink-0 items-center justify-center">
              {item.status === "done" ? (
                <span className="flex size-3.5 items-center justify-center rounded-[5px] border dark:border-[#ffb400]/25 light:border-[#d49600]/30 dark:bg-[#ffb400]/[0.08] light:bg-[#d49600]/[0.08]">
                  <CheckIcon className="size-2.5 dark:text-[#ffb400] light:text-[#d49600]" />
                </span>
              ) : item.status === "active" ? (
                <Loader2Icon className="size-3.5 animate-spin motion-reduce:animate-none dark:text-[#ffb400] light:text-[#d49600]" />
              ) : (
