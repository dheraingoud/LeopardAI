...
> & {
  ...
  return (
    <div
      ...
      className={cn(paper, "flex w-full max-w-md flex-col overflow-hidden rounded-lg", className)}
      {...props}
    >
                ...
                {hunk.decision === "pending" ? (
                  <>
                    ...
                    <button
                      ...
                      className="flex h-6 items-center gap-1 rounded-full px-2 text-[11px] font-medium transition-[background-color,scale] duration-150 active:scale-[0.96] dark:bg-[#ffb400]/12 dark:text-[#ffb400] dark:hover:bg-[#ffb400]/20 light:bg-[#d49600]/12 light:text-[#8a6500] light:hover:bg-[#d49600]/20"
                    >
