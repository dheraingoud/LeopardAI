...
> & {
  ...
  return (
    <div
      ...
      className={cn(paper, "flex w-full max-w-sm flex-col gap-3.5 rounded-lg p-4", className)}
      {...props}
    >
      <div className="flex items-center gap-2.5">
        <span className="flex size-7 shrink-0 items-center justify-center rounded-md dark:bg-[#ffb400]/[0.08] light:bg-[#d49600]/[0.08] dark:text-[#ffb400] light:text-[#d49600]">
        ...
        {fields.map((item) => (
          <div key={item.name} className="flex flex-col gap-1">
            ...
            {item.kind === "choice" ? (
              ...
              <span className="flex items-center gap-2">
                <span
                  ...
                  className={cn(
                    ...
                    item.value === "true" ? "dark:bg-[#ffb400]/80 light:bg-[#d49600]/80" : "bg-foreground/15",
                  )}
                >
                  <span
                    className={cn(
              ...
              <span className={cn(field, "text-foreground/80 rounded-md px-2.5 py-1.5 text-xs")}>
                {item.value}
              </span>
            )}
          </div>
