...
// Leopard fork of the kit TerminalBlock: shell-style command + output lines.
// The streaming renderer routes ```terminal / ```console fences here.
    ...
    >
      ...
      >
        ...
        {!done && (
          <span
            aria-hidden
            className="inline-block h-3 w-1.5 animate-pulse dark:bg-[#ffb400]/70 light:bg-[#d49600]/70 motion-reduce:animate-none"
          />
        )}
      </div>
    </div>
