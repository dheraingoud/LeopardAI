// Leopard fork of assistant-ui message-pair — originals in addons/ are reference-only.
"use client";
      ...
      <div className="group/message flex flex-col items-start">
        <p className="min-h-[4.25rem] text-sm leading-relaxed">
              ...
              >
                <span
                  className={cn(
                    ...
                    fresh && "dark:text-[#ffb400] light:text-[#d49600]",
                  )}
                >
                  {word}
                </span>{" "}
          ...
          {streaming && shown.length > 0 && (
            <span
              aria-hidden
              className="-mb-0.5 ml-0.5 inline-block h-4 w-0.5 animate-pulse rounded-full dark:bg-[#ffb400] light:bg-[#d49600] motion-reduce:animate-none dark:dark:bg-[#ffb400] light:bg-[#d49600]"
            />
          )}
        </p>
