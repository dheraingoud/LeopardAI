    ...
    >
      <div className={cn(paper, "flex items-center gap-2.5 rounded-2xl p-3")}>
        <span className="relative flex size-2 shrink-0">
          <span className="absolute inline-flex size-full animate-ping rounded-full bg-[#ffb400]/60 motion-reduce:hidden" />
          <span className="relative inline-flex size-2 rounded-full dark:bg-[#ffb400] light:bg-[#d49600]" />
        </span>
