// Leopard fork of assistant-ui speaker-identity — originals in addons/ are reference-only.
"use client";
...
const TONE: Record<SpeakerKind, string> = {
  ...
  agent: "bg-[#ffb400]/12 dark:text-[#ffb400] light:text-[#d49600] dark:bg-[#ffb400]/15 dark:dark:text-[#ffb400] light:text-[#d49600]",
