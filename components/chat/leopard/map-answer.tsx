// Leopard fork of assistant-ui map-answer — originals in addons/ are reference-only.
"use client";
        ...
        >
          ...
          {route && pins.length > 1 && (
            <polyline
              ...
              strokeDasharray="3 2"
              strokeLinecap="round"
              className="stroke-[#ffb400]/60 dark:stroke-[#ffb400]/60"
            />
          )}
        </svg>
          ...
          >
            <span
              className={cn(
                ...
                pin.id === activeId
                  ? "border-background size-3.5 dark:bg-[#ffb400] light:bg-[#d49600]"
